...
export function FunnelDashboard({ formData, diagnostics }: FunnelDashboardProps) {
  ...
  return (
    ...
    >
      <Card className="overflow-hidden border-blue-200 dark:border-blue-500/80 shadow-sm dark:bg-gray-600/95 dark:shadow-blue-900/10">
        ...
        <CardContent className="p-4 md:p-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid grid-cols-3 mb-6 bg-gray-100 dark:bg-gray-500/90 p-1 rounded-xl">
              <TabsTrigger 
                value="overview"
