...
export const DiagnosticCard = ({ 
  ...
  return (
    <div className={cn(
      "p-4 bg-white dark:bg-gray-600/95 rounded-lg shadow-sm transition-all hover:shadow-md dark:shadow-blue-900/10 border dark:border-blue-500/80", 
      className
    )}>
          ...
          {tooltip && (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="dark:bg-gray-600 dark:text-white dark:border-blue-500">
